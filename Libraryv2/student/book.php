...
<?php
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['Textbook'];
                                            ...
                                            $sql="select * from Libraryv2.book where Section like '%$s%' OR Textbook like '%$s%'";
                                        }
                                    else
                     ...
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php
                           ...
                           <tr>
                              ...
                              <a class="btn btn-sm btn-success" href="bookdetails.php?id=<?php echo $bookid; ?>"><i
                                    class="fa fa-info-circle">Edit</i></a>   
                                    <?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue_request.php?id=".$bookid."\" class=\"btn btn-sm btn-success\"><i class=\"fa fa-check\">Borrow</i></a>";
                                        ?>
                              </div>
                              </td>
                           </tr>
