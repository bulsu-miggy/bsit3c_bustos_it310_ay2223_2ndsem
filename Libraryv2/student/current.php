         ...
         <div class="content-wrapper">
            ...
            <?php
             ...
             if(isset($_POST['submit']))
                 {$s=$_POST['title'];
                     $sql="select * from Libraryv2.record,Libraryv2.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";

                 }
             else
             $sql="select * from Libraryv2.record,Libraryv2.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId";
                        ...
                        <?php
                          ...
                          ?>
                           ...
                           <td><?php echo $duedate ?></td>
                              ...
                              <?php 
                  if($renewals)
                     echo "<a href=\"renew_request.php?id=".$bookid."\" class=\"btn btn-sm btn-success\">Renew</a>";
                 ?>
                 <a href="return_request.php?id=<?php echo $bookid; ?>" class="btn btn-sm btn-warning">Return</a>
                              </div>
                              </td>
                           </tr>
                          <?php } ?>
