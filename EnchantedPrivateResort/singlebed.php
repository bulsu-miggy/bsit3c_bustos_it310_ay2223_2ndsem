...
<html lang="en" dir="ltr">
  <head>
    <title>Single Bed Room | Enchanted Isle Resort</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="stylesheet" href="singlebed.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="area-container-1">
      ...
      <div class="container-1">
        <div class="image">
          <img src="Pictures/singlebed.png" alt="rooms" />
        </div>
        <div class="text">
          <h2>Room Details</h2>
          <p class="p1">
          Maximum occupancy of 2 Adults and 1 Child
          </p>
         </br>   
