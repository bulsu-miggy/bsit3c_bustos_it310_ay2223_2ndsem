...
<html lang="en" dir="ltr">
  <head>
    <title>Three Beds Room | Enchanted Isle Resort</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="stylesheet" href="threebeds.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="area-container-1">
      ...
      <div class="container-1">
        <div class="image">
          <img src="Pictures/threebeds.png" alt="rooms" />
        </div>
        <div class="text">
          <h2>Room Details</h2>
          <p class="p1">
          Maximum occupancy of 5 Adults and 3 Child
          </p>
        </br>
          ...
          <li>
            ...
            <li>
              3FT to 5FT swimming pool access
            </li>
          </ul>
