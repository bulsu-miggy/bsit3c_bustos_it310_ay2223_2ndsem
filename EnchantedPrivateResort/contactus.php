...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="area-container-1">
            ...
            <div class="container">
                <ul>
                    <li><i class="fa fa-map-marker"></i> 7302 Sulivan, San Jose, Pampanga</li>
                    <li><i class="fa fa-phone"></i> &#40;+63&#41;964-728-3471</li>
                    <li><i class="fa fa-envelope"></i> <u>enchantedisleprivateresort@gmail.com</u></li>
                </ul>
            </div>
        </div>
