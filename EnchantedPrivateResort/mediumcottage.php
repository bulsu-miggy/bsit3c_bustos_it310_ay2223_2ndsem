...
<html lang="en" dir="ltr">
  <head>
    <title>Medium Cottage | Enchanted Isle Resort</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="stylesheet" href="mediumcottage.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="area-container-1">
      ...
      <div class="container-1">
        <div class="image">
          <img src="Pictures/mediumcottage.png" alt="rooms" />
        </div>
        <div class="text">
          <h2>Room Details</h2>
          <p class="p1">
          Maximum occupancy of 3 Adults and 2 Child
          </p>
          </br>
          ...
          <li>
            ...
            <li>
              Videoke (Until 9pm Only)
            </li>
            <li>
              Two Bottles of water
            </li>
            <li>
              Private pool of 4FT To 7FT
            </li>
          </ul>
          <a class="button" href="booknow.php"><button>Book Now!</button></a>
          <a class="button" href="roomsandcotagges.php"><button class="back">Back</button></a>
        </div>
      </div>
    </div>
    <footer>
